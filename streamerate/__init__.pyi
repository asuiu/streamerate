...
class stream(Iterable[_K]):
    ...
    def mpmap(
        self, f: Callable[[_K], _V], poolSize: int = ..., bufferSize: Optional[int] = 1, start_method: Literal["spawn", "fork", "forkserver"] = ...
    ) -> stream[_V]: ...
    def mpstarmap(
        self: stream[Iterable[_K | Any]],
        f: Callable[[_K | Any, ...], _V],
        poolSize: Union[int, Pool] = ...,
    ...
    def faststarmap(
        self: stream[Iterable[_K | Any]], f: Callable[[_K | Any, ...], _V], poolSize: int = ..., bufferSize: Optional[int] = None
    ) -> stream[_V]: ...
    def mtmap(self, f: Callable[[_K], _V], poolSize: int = ..., bufferSize: Optional[int] = None) -> stream[_V]: ...
    def mtstarmap(self: stream[Iterable[_K | Any]], f: Callable[[_K | Any, ...], _V], poolSize: int = ..., bufferSize: Optional[int] = None) -> stream[_V]: ...
    def gtmap(self, f: Callable[[_K], _V], poolSize: int = ...) -> stream[_V]: ...
    def gtfastmap(self, f: Callable[[_K], _V], poolSize: int = ...) -> stream[_V]: ...
    def gtstarmap(self: stream[Iterable[_K | Any]], f: Callable[[_K | Any, ...], _V], poolSize: int = ...) -> stream[_V]: ...
    @overload
    def fastFlatMap(
        self,
    ...
    def starfilter(self: stream[Iterable[_K | Any]], predicate: Callable[[_K | Any, ...], bool]) -> stream[_K]: ...
